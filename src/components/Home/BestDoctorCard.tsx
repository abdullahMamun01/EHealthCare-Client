...
export function BestDoctorCard({ name, credentials, location, consultations, rating, priceRange }: DoctorCardProps) {
  return (
    <Card variant="outlined" styles={{
      ...
      <div className="relative mb-4 bg-sky-50 px-4">
      ...
      <h3 className="mt-3 text-xl font-bold text-gray-700 px-2">{name}</h3>
      <p className="text-sm text-gray-600 px-2 line-clamp-1">{credentials}</p>
      ...
      <div className="mt-4 flex items-center gap-2 text-sm text-gray-600 line-clamp-1 px-1">
        ...
        <span className="ml-auto flex items-center gap-1">
          ...
          <span>{consultations}</span> Consultations
        </span>
      </div>

      <div className="mt-4 flex gap-3 px-2 ">
        <Button className="!flex-1 !rounded-md !bg-gray-700 !px-4 !py-2 !text-sm !font-medium !text-white !hover:bg-navy-800 ">
          View Profile
        </Button>
